      ...
      <div className="flex items-start">
        ...
        >
          ...
          <div className="flex w-full items-center gap-4">
            <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full font-bold text-white shadow-sm ${BADGE_COLORS[index % BADGE_COLORS.length]}`}>
              {index + 1}
            </div>
            <h3 className="flex-1 min-w-0 font-heading text-lg font-bold leading-snug text-neutral-900">
              {strategy.title}
            </h3>
          </div>
              ...
              {strategy.steps ? (
                <div className="flex flex-col gap-4">
                  {strategy.steps.prep.length > 0 && (
                    <div>
                      <div className="mb-2 flex items-center gap-2">
                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 text-sm font-bold text-primary-700" aria-hidden="true">1</span>
                        <h5 className="text-sm font-semibold uppercase tracking-wide text-neutral-600">Prep</h5>
                      </div>
                  ...
                  {strategy.steps.during.length > 0 && (
                    <div>
                      <div className="mb-2 flex items-center gap-2">
                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 text-sm font-bold text-primary-700" aria-hidden="true">2</span>
                        <h5 className="text-sm font-semibold uppercase tracking-wide text-neutral-600">During</h5>
                      </div>
                      <ul className="list-disc space-y-1.5 pl-4 marker:text-neutral-400">
                  ...
                  {strategy.steps.follow_up.length > 0 && (
                    <div>
                      <div className="mb-2 flex items-center gap-2">
                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 text-sm font-bold text-primary-700" aria-hidden="true">3</span>
                        <h5 className="text-sm font-semibold uppercase tracking-wide text-neutral-600">Follow-Up</h5>
                      </div>
                      <ul className="list-disc space-y-1.5 pl-4 marker:text-neutral-400">
